...
/* STM8S208R */
	...
	#ifdef __SDCC
		#define DEF_8BIT_REG_AT(NAME,ADDRESS) __at(ADDRESS) volatile unsigned char NAME
		#define DEF_16BIT_REG_AT(NAME,ADDRESS) __at(ADDRESS) volatile unsigned int NAME
	#endif
