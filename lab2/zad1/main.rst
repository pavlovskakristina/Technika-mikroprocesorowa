      ...
      008000 82 00 80 07            542 	int s_GSINIT ; reset
                                    ...
                                    548 	.area GSFINAL
                                    549 	.area GSINIT
      008007 CD 80 A6         [ 4]  550 	call	___sdcc_external_startup
      ...
      008004 CC 80 2D         [ 2]  580 	jp	_main
                                    ...
                                    589 ;	-----------------------------------------
      00802D                        590 _main:
                                    591 ;	main.c: 6: PB_DDR &= ~(1<<4);
      00802D 72 19 50 07      [ 1]  592 	bres	_PB_DDR+0, #4
                                    593 ;	main.c: 7: PB_CR1 &= ~(1<<4);
      008031 72 19 50 08      [ 1]  594 	bres	_PB_CR1+0, #4
                                    595 ;	main.c: 8: PB_CR2 &= ~(1<<4);
      008035 72 19 50 09      [ 1]  596 	bres	_PB_CR2+0, #4
                                    597 ;	main.c: 11: PC_DDR |= (1<<5);
      008039 72 1A 50 0C      [ 1]  598 	bset	_PC_DDR+0, #5
                                    599 ;	main.c: 12: PC_CR1 |= (1<<5);
      00803D 72 1A 50 0D      [ 1]  600 	bset	_PC_CR1+0, #5
                                    601 ;	main.c: 13: PC_CR2 |= (1<<5);
      008041 72 1A 50 0E      [ 1]  602 	bset	_PC_CR2+0, #5
                                    603 ;	main.c: 16: PC_DDR |= (1<<7);
      008045 72 1E 50 0C      [ 1]  604 	bset	_PC_DDR+0, #7
                                    605 ;	main.c: 17: PC_CR1 |= (1<<7);
      008049 72 1E 50 0D      [ 1]  606 	bset	_PC_CR1+0, #7
                                    607 ;	main.c: 18: PC_CR2 |= (1<<7);
      00804D 72 1E 50 0E      [ 1]  608 	bset	_PC_CR2+0, #7
                                    609 ;	main.c: 22: PB_DDR &= ~(1<<3);
      008051 72 17 50 07      [ 1]  610 	bres	_PB_DDR+0, #3
                                    611 ;	main.c: 23: PB_CR1 &= ~(1<<3);
      008055 72 17 50 08      [ 1]  612 	bres	_PB_CR1+0, #3
                                    613 ;	main.c: 24: PB_CR2 &= ~(1<<3);
      008059 72 17 50 09      [ 1]  614 	bres	_PB_CR2+0, #3
                                    615 ;	main.c: 27: PC_DDR |= (1<<6);
      00805D 72 1C 50 0C      [ 1]  616 	bset	_PC_DDR+0, #6
                                    617 ;	main.c: 28: PC_CR1 |= (1<<6);
      008061 72 1C 50 0D      [ 1]  618 	bset	_PC_CR1+0, #6
                                    619 ;	main.c: 29: PC_CR2 |= (1<<6);
      008065 72 1C 50 0E      [ 1]  620 	bset	_PC_CR2+0, #6
                                    621 ;	main.c: 32: PE_DDR |= (1<<5);
      008069 72 1A 50 16      [ 1]  622 	bset	_PE_DDR+0, #5
                                    623 ;	main.c: 33: PE_CR1 |= (1<<5);
      00806D 72 1A 50 17      [ 1]  624 	bset	_PE_CR1+0, #5
                                    625 ;	main.c: 34: PE_CR2 |= (1<<5);
      008071 72 1A 50 18      [ 1]  626 	bset	_PE_CR2+0, #5
                                    627 ;	main.c: 36: while (1)
      008075                        628 00108$:
                                    629 ;	main.c: 38: if ((PB_IDR & (1<<4)) == 0){
      008075 72 08 50 06 0A   [ 2]  630 	btjt	_PB_IDR+0, #4, 00102$
                                    631 ;	main.c: 39: PC_ODR &= ~(1<<5);
      00807A 72 1B 50 0A      [ 1]  632 	bres	_PC_ODR+0, #5
                                    633 ;	main.c: 40: PC_ODR &= ~(1<<7);
      00807E 72 1F 50 0A      [ 1]  634 	bres	_PC_ODR+0, #7
      008082 20 08            [ 2]  635 	jra	00103$
      008084                        636 00102$:
                                    637 ;	main.c: 43: PC_ODR |= (1<<5);
      008084 72 1A 50 0A      [ 1]  638 	bset	_PC_ODR+0, #5
                                    639 ;	main.c: 44: PC_ODR |= (1<<7);
      008088 72 1E 50 0A      [ 1]  640 	bset	_PC_ODR+0, #7
      00808C                        641 00103$:
                                    642 ;	main.c: 47: if ((PB_IDR & (1<<3)) == 0){
      00808C 72 06 50 06 0A   [ 2]  643 	btjt	_PB_IDR+0, #3, 00105$
                                    644 ;	main.c: 48: PC_ODR &= ~(1<<6);
      008091 72 1D 50 0A      [ 1]  645 	bres	_PC_ODR+0, #6
                                    646 ;	main.c: 49: PE_ODR &= ~(1<<5);
      008095 72 1B 50 14      [ 1]  647 	bres	_PE_ODR+0, #5
      008099 20 DA            [ 2]  648 	jra	00108$
      00809B                        649 00105$:
                                    650 ;	main.c: 52: PC_ODR |= (1<<6);
      00809B 72 1C 50 0A      [ 1]  651 	bset	_PC_ODR+0, #6
                                    652 ;	main.c: 53: PE_ODR |= (1<<5);
      00809F 72 1A 50 14      [ 1]  653 	bset	_PE_ODR+0, #5
      0080A3 20 D0            [ 2]  654 	jra	00108$
                                    655 ;	main.c: 56: }
      0080A5 81               [ 4]  656 	ret
                                    657 	.area CODE
                                    658 	.area CONST
                                    659 	.area INITIALIZER
                                    660 	.area CABS (ABS)
